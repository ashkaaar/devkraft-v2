...
module.exports = [
  {
    ...
    message: `Geeks! We are back!
    Team DevKraft in association with Dr D.Y. Patil Institute Of Technology, Pimpri, Pune presents DevTalks Episode 2.
    
    We are inviting the luminary Sandeep Jain, Founder and CEO at GeeksforGeeks to discuss various topics like stepping up your programming game, market expectations for freshies, entrepreneurship etc.
    
    We would appreciate your presence at our event.
    
    Venue: DPU Auditorium
    
    Register on the link👇 
    https://forms.gle/r8TymUUfnHDZaLh18 `,
    link: 'https://forms.gle/r8TymUUfnHDZaLh18'
  },
