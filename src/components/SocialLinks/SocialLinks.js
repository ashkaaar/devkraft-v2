  ...
  render () {
    ...
    return (
      <div
        ...
        {...etc}
      >
        <A href='https://youtube.com/channel/UCn1IkyUJZM4zonfScEfxb9Q' title='YouTube' target='youtube'>
          <span className='mdi mdi-youtube' />
        </A>
        <A href='https://www.linkedin.com/company/dev-kraft/' title='Linkedin' target='Linkedin'>
        ...
        <A href='https://www.facebook.com/Team-DevKraft-109241814987333/' title='Facebook' target='facebook'>
          <span className='mdi mdi-facebook' />
        </A>
        <A href='https://twitter.com/devkraftdpu?t=zPPZUk4NXR4YTQU-oH0nTw&s=09' title='Twitter' target='twitter'>
          <span className='mdi mdi-twitter' />
        </A>
        <A href='https://instagram.com/devkraft.dpu?igshid=YmMyMTA2M2Y=' title='Instagram' target='instagram'>
          <span className='mdi mdi-instagram' />
        </A>
        <A href='mailto:devkraftclub@gmail.com' title='Email' target='email'>
